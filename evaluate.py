...
if __name__ == "__main__":
    ...
    for i in x:
        print(i)
        result = results(str(args.topic_id), int(args.top_k), str('Documents identify invasive species in the U'), str(args.vector_name), str(args.index_name), str(args.custom))
        s = Score
        print(s.eval(result, args.top_k))
